...
int fullArray(Employee listing[],int len)
{
    ...
    for(i=0;i<len;i++)
    {
        ...
        {
            printf("No quedan lugares libres, borre o modifique algun  empleado\n");
            break;
        }
    }
    return 0;
...
int deleteEmployee(Employee listing[], int len)
{
    ...
    {
        printf(" NO se cargaron personas en el sistema!!\n");
        loEncontro = 1;
    }
...
{
    float salary[3]={6510,2562.95,1222.52};
    char name[3][50]={"Jorge","Gabriel","Cristian"};
    char lastName[3][50]={"Fongia","Rambo","Bart"};
